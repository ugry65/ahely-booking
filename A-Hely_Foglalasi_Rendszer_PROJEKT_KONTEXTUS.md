...
- kötelező e-mail issue #107 / draft PR #111: minden create/update/delete után a booking owner kap levelet, admin műveletnél is; sorozatnál 1 összefoglaló e-mail; a külön, verziózott outbox, lease/retry/dead-letter RPC és a kanonikus booking műveletek tranzakcióvégi enqueue-integrációja elkészült a draft ágon; Database tests #525: 714/714 pgTAP + minden konkurenciateszt + schema lint PASS, Application checks #576 PASS; stagingre nincs alkalmazva, a worker és szolgáltatói UAT még nyitott;
