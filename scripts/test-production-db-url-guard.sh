...
"$guard" 'postgresql://postgres:secret@db.yasrmxwjojepessivhmc.supabase.co:5432/postgres'
"$guard" 'postgres://postgres.yasrmxwjojepessivhmc:secret@aws-0-eu-west-2.pooler.supabase.com:5432/postgres'
expect_fail ''
