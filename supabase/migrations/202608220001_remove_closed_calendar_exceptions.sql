...
comment on function public.assert_booking_request(
  ...
  'Közös foglalási validátor. Az A-Hely minden naptári napon foglalható az app_settings opening_time és closing_time közötti idősávban; globális zárt nap nincs.';
