...
select ok(position('booking.start_at > now()' in pg_get_functiondef('public.list_my_bookings()'::regprocedure)) > 0,
  'A read-model a már elkezdődött foglalásokat is determinisztikusan kizárja');
