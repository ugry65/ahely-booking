...
insert into generic_payload values (jsonb_build_array(
  jsonb_build_object('sourceFingerprint',encode(digest('generic-1','sha256'),'hex'),'roomName','Forrás tér','startLocal','2031-02-03 08:00','endLocal','2031-02-03 09:00','durationMinutes',60,'bookingTitle','Első foglalás','useType','individual'),
  jsonb_build_object('sourceFingerprint',encode(digest('generic-2','sha256'),'hex'),'roomName','Tréningterem','startLocal','2031-02-04 09:00','endLocal','2031-02-04 10:30','durationMinutes',90,'bookingTitle','Egyéni tréning','useType','individual'),
  jsonb_build_object('sourceFingerprint',encode(digest('generic-3','sha256'),'hex'),'roomName','Tréningterem','startLocal','2031-02-05 10:00','endLocal','2031-02-05 12:00','durationMinutes',120,'bookingTitle','Csoport','useType','group')
));
...
select jsonb_set(data, '{0,roomName}', '"Tréningterem"'::jsonb) from generic_payload;
...
select throws_ok(
  $$select public.admin_import_allbooked_customer(
    ...
    jsonb_build_array(jsonb_build_object('sourceFingerprint',encode(digest('bad-group','sha256'),'hex'),'roomName','Forrás tér','startLocal','2031-03-01 08:00','endLocal','2031-03-01 09:00','durationMinutes',60,'bookingTitle',null,'useType','group')),
...
insert into conflicting_payload values (jsonb_build_array(
  jsonb_build_object('sourceFingerprint',encode(digest('atomic-1','sha256'),'hex'),'roomName','Tréningterem','startLocal','2031-04-01 08:00','endLocal','2031-04-01 09:00','durationMinutes',60,'bookingTitle',null,'useType','individual'),
  jsonb_build_object('sourceFingerprint',encode(digest('atomic-2','sha256'),'hex'),'roomName','Forrás tér','startLocal','2031-04-02 08:00','endLocal','2031-04-02 09:00','durationMinutes',60,'bookingTitle',null,'useType','individual')
));
...
select lives_ok(
  $$select public.admin_import_allbooked_customer(
    ...
    jsonb_build_array(jsonb_build_object('sourceFingerprint',encode(digest('papp-real-v2','sha256'),'hex'),'roomName','Forrás tér','startLocal','2026-09-03 08:00','endLocal','2026-09-03 09:00','durationMinutes',60,'bookingTitle','Valós foglalás','useType','individual')),
