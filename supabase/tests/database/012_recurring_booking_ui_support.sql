...
insert into public.booking_series (
  id, owner_user_id, created_by, frequency, starts_on, occurrence_count,
  conflict_policy, room_id, local_start_time, duration_minutes, use_type,
  idempotency_key, request_payload
) values (
  '33000000-0000-0000-0000-000000000151',
  '00000000-0000-0000-0000-000000000153',
  '00000000-0000-0000-0000-000000000153',
  'weekly', current_date + 7, 2, 'abort_all',
  '11000000-0000-0000-0000-000000000002', '09:00', 60, 'individual',
  '34000000-0000-0000-0000-000000000151', '{}'::jsonb
);
