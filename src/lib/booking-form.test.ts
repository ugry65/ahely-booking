...
const valid = { roomId: "11000000-0000-0000-0000-000000000002", date: "2026-09-10", startTime: "09:00", endTime: "10:00", useType: "individual", note: " Rövid megjegyzés " };
describe("booking form", () => {
  ...
  it("érvényes foglalást RPC-paraméterré alakít", () => expect(parseBookingForm(valid)).toEqual({ ok: true, value: { roomId: valid.roomId, date: valid.date, startAt: "2026-09-10T07:00:00.000Z", endAt: "2026-09-10T08:00:00.000Z", useType: "individual", note: "Rövid megjegyzés" } }));
