...
const valid = { roomId: "11000000-0000-0000-0000-000000000002", date: "2026-09-10", startTime: "09:00", endTime: "10:00", useType: "individual", note: " Sorozat ", idempotencyKey: "34000000-0000-0000-0000-000000000001", frequency: "weekly", conflictPolicy: "create_available", endMode: "count", occurrenceCount: "6", endsOn: "", exceptionDates: "2026-09-17, 2026-09-24\n2026-09-17" };

describe("recurring booking form", () => {
  it("darabszámos sorozatot normalizál és deduplikálja a kivételdátumokat", () => expect(parseRecurringBookingForm(valid)).toMatchObject({ ok: true, value: { occurrenceCount: 6, endsOn: null, exceptionDates: ["2026-09-17", "2026-09-24"], note: "Sorozat" } }));
