    ...
    <nav className="mobile-app-nav" aria-label="Mobil navigáció">
      ...
      <details className="mobile-app-menu" ref={menuRef}>
        ...
        <div className="mobile-app-menu-panel">
          ...
          {isAdmin ? <Link href="/admin/dijazas" onClick={closeMenu}>Díjazás</Link> : null}
          ...
          {isAdmin ? <Link href="/admin/email-ertesitesek" onClick={closeMenu}>E-mail kézbesítés</Link> : null}
          {isAdmin ? <Link href="/admin/migracio" onClick={closeMenu}>Migráció</Link> : null}
